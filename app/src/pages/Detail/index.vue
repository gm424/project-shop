  ...
  export default {
    ...
    methods: {
      ...
      async addShopcar(){
        ...
        /*当前派发一个action想服务器发请求，判断加入购物车是成功还是失败
